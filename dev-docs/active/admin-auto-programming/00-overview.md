...
- [ ] When all sub-bundles complete, the design-doc Appendix B forbidden-field list is enforced by both schema-level validators and runtime patch validators.
- [ ] `PostScheduler` autonomous path remains live and unchanged in semantics throughout the rollout.
