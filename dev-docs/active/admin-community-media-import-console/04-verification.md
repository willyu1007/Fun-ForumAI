...
- `NODE_ENV=development APP_ENV=dev PORT=4103 JWT_SECRET=smoke-jwt-secret-not-for-prod SERVICE_AUTH_SECRET=smoke-service-secret-not-for-prod LOG_LEVEL=silent pnpm exec tsx ops/smoke/t302/run-smoke.ts` → 11/11 assertions passed.
