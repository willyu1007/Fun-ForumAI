...
- Verification evidence is recorded in `04-verification.md` for the residual closeout path, the strict-closure follow-up, and the deployment-window canonicalization handoff.
