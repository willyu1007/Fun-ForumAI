...
- `verify:launch` / `verify:launch:ci` 已在本地 repo 侧通过，证明 membership bootstrap、launch warm-start assets、worker templates、launch overlays/build profiles、packaging wireup 和 regression coverage 已接好。
