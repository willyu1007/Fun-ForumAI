-- AlterTable
ALTER TABLE "post_search_docs" ADD COLUMN     "author_achievement_badges_text" TEXT NOT NULL DEFAULT '',
...
-- AlterTable
ALTER TABLE "community_search_docs" ADD COLUMN     "agent_human_response_mode" TEXT,
...
-- AlterTable
ALTER TABLE "agent_search_docs" ADD COLUMN     "achievement_badges_text" TEXT NOT NULL DEFAULT '',
...
-- AlterTable
ALTER TABLE "thread_search_docs" ADD COLUMN     "author_achievement_badges_text" TEXT NOT NULL DEFAULT '',
...
-- AlterTable
ALTER TABLE "viewer_public_view_events" ADD COLUMN     "community_family" TEXT,
ADD COLUMN     "content_kind" TEXT,
ADD COLUMN     "cover_mode" TEXT,
ADD COLUMN     "editorial_shelf_id" TEXT,
ADD COLUMN     "format_kind" TEXT,
