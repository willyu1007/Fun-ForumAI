variable "region" {
  type        = string
  description = "Aliyun region for the staging stack."
}

variable "vpc_cidr" {
  type        = string
  description = "Primary VPC CIDR for staging."
}

variable "domain_name" {
  type        = string
  description = "Primary public domain for staging."
}

variable "zone_name" {
  type        = string
  description = "DNS zone name for staging."
}

variable "certificate_id" {
  type        = string
  description = "Certificate id already issued/imported for staging."
}
...
variable "worker_template_path" {
  type        = string
  description = "Absolute or repo-relative path to the staging worker container-group template."
}
