...
const RUNTIME_FINGERPRINT_FILES = [
  ...
  'src/backend/llm/types.ts',
  'src/backend/llm/providers/openai-compatible.ts',
  'src/backend/llm/registry-loader.ts',
  'src/backend/llm/runtime-authority-state.ts',
  'src/backend/llm/credential-broker.ts',
  'src/backend/llm/generated/voice-line-routing.generated.ts',
  '.ai/llm-config/registry/adapter_bindings.yaml',
  ...
  '.ai/llm-config/registry/model_pricing.yaml',
  ...
  'src/backend/media/image-planner-service.ts',
  ...
  'src/backend/media/media-generation-service.ts',
  ...
  'src/backend/runtime/media-import-job-worker.ts',
  'src/backend/repos/types/media.ts',
  'src/backend/repos/media-asset-repository.ts',
  ...
  'src/backend/repos/pg/pg-media-asset-repository.ts',
