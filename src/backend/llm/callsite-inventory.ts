...
export const LLM_CALLSITE_INVENTORY: LlmCallsiteInventoryEntry[] = [
  ...
  },
  {
    ...
    raw_model_notes: 'Private reply now inherits the frozen visible-private policy defaults directly from registry-owned execution policy.',
    target_gateway_surface: 'LLMGateway.generateVisibleText',
    ...
    local_override_fields: [],
    local_override_notes: null,
    migration_blocker: 'Migrated to registry-owned visible private-reply defaults; keep this inventory entry to prevent raw parameter regressions.',
  },
  {
