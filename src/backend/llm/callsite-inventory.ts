...
export const LLM_CALLSITE_INVENTORY: LlmCallsiteInventoryEntry[] = [
  {
    ...
    local_override_fields: ['executionPolicyId'],
    local_override_notes: 'Forum-post body writes explicitly override the default forum reply base policy to avoid long timeout/retry tails on root events.',
