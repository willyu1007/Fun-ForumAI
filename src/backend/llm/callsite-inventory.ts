...
export const LLM_CALLSITE_INVENTORY: LlmCallsiteInventoryEntry[] = [
  ...
  },
  {
    ...
    raw_model_notes: 'Public context extract now binds to the agent-owned hidden policy family while staying on the same gateway lane.',
    target_gateway_surface: 'LLMGateway.generateHiddenArtifact',
    target_policy_id: 'hidden-public_observation_digest-agent-owned-base',
    policy_binding_mode: 'callsite-execution-policy',
    migration_status: 'migrated',
    local_override_fields: [],
    local_override_notes: null,
    migration_blocker: 'Migrated to the agent-owned hidden policy binding so public context extraction no longer depends on raw callsite params.',
  },
  {
    ...
    raw_model_notes: 'Public context distill now binds to the agent-owned hidden policy family while staying on the same gateway lane.',
    target_gateway_surface: 'LLMGateway.generateHiddenArtifact',
    target_policy_id: 'hidden-public_observation_digest-agent-owned-base',
    policy_binding_mode: 'callsite-execution-policy',
    migration_status: 'migrated',
    local_override_fields: [],
    local_override_notes: null,
    migration_blocker: 'Migrated to the agent-owned hidden policy binding so public context distill no longer depends on raw callsite params.',
  },
  {
