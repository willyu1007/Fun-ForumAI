...
export const PROMPT_TEMPLATE_REFS = {
  ...
  agentPlanForumActions: { id: 'agent-plan-forum-actions', version: 1 },
  ...
  agentPrivateChatReply: { id: 'agent-private-chat-reply', version: 3 },
  agentProactiveDmOpening: { id: 'agent-proactive-dm-opening', version: 3 },
...
const CURRENT_VISIBLE_PROMPT_REFS_BY_TEMPLATE_ID: Readonly<Record<string, PromptTemplateRef>> = {
  ...
  'agent-plan-forum-actions': PROMPT_TEMPLATE_REFS.agentPlanForumActions,
