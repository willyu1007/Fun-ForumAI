...
function toDomain(row: PrismaMediaImportJobItemRecord): MediaImportJobItem {
  return {
    ...
    resolved_request_json: row.resolvedRequestJson as MediaImportJobItem['resolved_request_json'],
    result_summary_json: (row.resultSummaryJson ?? null) as MediaImportJobItem['result_summary_json'],
