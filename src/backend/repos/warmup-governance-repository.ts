...
export class InMemoryWarmupGovernanceRepository implements WarmupGovernanceRepository {
  ...
  async createBaseline(input: CreateKickoffBaselineInput): Promise<KickoffBaseline> {
    ...
    const baseline: KickoffBaseline = {
      ...
      runtime_mode: input.runtime_mode ?? 'blocked',
      runtime_force_override_reason: input.runtime_force_override_reason ?? null,
      runtime_force_override_set_by: input.runtime_force_override_set_by ?? null,
      runtime_force_override_set_at: input.runtime_force_override_set_at ?? null,
      runtime_force_override_expires_at: input.runtime_force_override_expires_at ?? null,
