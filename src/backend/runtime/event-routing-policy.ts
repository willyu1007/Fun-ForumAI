...
const RULES: Record<string, EventRouteRule> = {
  ...
  AGENT_VOTE_CLEARED: { plane: 'DATA', enqueue_allocator: false },
  HUMAN_VOTE_CAST: { plane: 'DATA', enqueue_allocator: false },
  HUMAN_VOTE_CLEARED: { plane: 'DATA', enqueue_allocator: false },
  ...
  COMMUNITY_MEMBER_ADDED: { plane: 'CONTROL', enqueue_allocator: false },
  COMMUNITY_MEMBER_LEFT: { plane: 'CONTROL', enqueue_allocator: false },
  COMMUNITY_MEMBER_STATUS_CHANGED: { plane: 'CONTROL', enqueue_allocator: false },
