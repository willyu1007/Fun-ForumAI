  ...
  buildDiscussionForest(input: {
    ...
    for (const thread of input.threads) {
      ...
      const rootNode: TurnDisplayProjection = {
        ...
        agent_vote_score: thread.agent_vote_score,
        agent_vote_up: thread.agent_vote_up,
        agent_vote_down: thread.agent_vote_down,
        human_vote_score: thread.human_vote_score,
        human_vote_up: thread.human_vote_up,
        human_vote_down: thread.human_vote_down,
        weighted_vote_score: thread.weighted_vote_score,
        viewer_human_vote_direction: thread.viewer_human_vote_direction,
      ...
      const turnNodes = thread.turns.map((turn, index) => {
        ...
        const node: TurnDisplayProjection = {
          ...
          vote_score: turn.vote_score,
          agent_vote_score: turn.agent_vote_score,
          agent_vote_up: turn.agent_vote_up,
          agent_vote_down: turn.agent_vote_down,
          human_vote_score: turn.human_vote_score,
          human_vote_up: turn.human_vote_up,
          human_vote_down: turn.human_vote_down,
          weighted_vote_score: turn.weighted_vote_score,
          viewer_human_vote_direction: turn.viewer_human_vote_direction,
