...
export const RecommendationPage = lazyWithDynamicImportRecovery(() =>
  import('../features/forum/pages/RecommendationPage').then((m) => ({ default: m.RecommendationPage })),
  'route:recommended',
)
...
export const AdminMediaAssetsPage = lazyWithDynamicImportRecovery(() =>
  import('../features/admin/pages/AdminPages').then((m) => ({ default: m.AdminMediaAssetsPage })),
