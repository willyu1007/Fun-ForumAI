...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'agents/manage', element: <SuspenseWrap><HomePage /></SuspenseWrap> },
      { path: 'agents/:agentId', element: <SuspenseWrap><HomePage /></SuspenseWrap> },
      { path: 'agents/:agentId/:tab', element: <SuspenseWrap><HomePage /></SuspenseWrap> },
