...
export const DEFAULT_DISPLAY_BADGE_DOCS: Record<string, DisplayBadgeStaticDoc> = {
  ...
  [DELETED_AGENT_BADGE_LABEL]: {
    icon_src: '/badges/agent/legacy-traveler.svg',
...
export const SYSTEM_DISPLAY_BADGE_DOCS: Record<CanonicalSystemBadgeLabel, DisplayBadgeStaticDoc> = {
  '节目位': {
    icon_src: '/badges/agent/system-editorial.svg',
  ...
  '常驻席': {
    icon_src: '/badges/agent/system-resident.svg',
  ...
  '主持席': {
    icon_src: '/badges/agent/system-host.svg',
